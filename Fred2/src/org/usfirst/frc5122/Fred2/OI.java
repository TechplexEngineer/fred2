...
//        SmartDashboard.putData("a_drive_turn_angle(-45)", new a_drive_turn_angle(-45));
        ...
        SmartDashboard.putData("05 a_drive_turn_angle(45)", new a_drive_turn_angle(45));
        SmartDashboard.putData("06 a_drive_move_dist(40)", new a_drive_move_dist(40));
        SmartDashboard.putData("07 a_drive_turn_angle(-45)", new a_drive_turn_angle(-45));
        SmartDashboard.putData("08 a_drive_move_dist(15)", new a_drive_move_dist(15));
        SmartDashboard.putData("09 a_drive_turn_angle(-45)", new a_drive_turn_angle(-45));
        SmartDashboard.putData("10 a_drive_move_dist(35)", new a_drive_move_dist(35));
        SmartDashboard.putData("11 a_drive_turn_angle(45)", new a_drive_turn_angle(45));
        SmartDashboard.putData("12 a_drive_strafe_dist(12, .5)", new a_drive_strafe_dist(12, .5));
    }
