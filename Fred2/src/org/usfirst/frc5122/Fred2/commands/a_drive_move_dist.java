...
public class  a_drive_move_dist extends PIDCommand {
    ...
    public a_drive_move_dist(double distance) {
        ...
        super("a_drive_move_dist", 0.11, 0.0, 0.0, 0.01);
    ...
    public a_drive_move_dist(double distance, double kp, double ki, double kd, double max) {
    	//super("a_drive_move_dist", 0.051, 0.0005, .5, 0.02);
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        super("a_drive_move_dist", kp, ki, kd, 0.02);
        getPIDController().setContinuous(false);
        getPIDController().setAbsoluteTolerance(0.2);
...
//    	return getPIDController().getError() <= THRESH;
    	return Math.abs(getPIDController().getError()) <= .9 && RobotMap.driveLeftEncoder.getRate() < .5;
