 ...
 *
 */
public class auto_1tote_pos1_lm2 extends CommandGroup {
    
    public  auto_1tote_pos1_lm2() {
        // Add Commands here:
    	...
    	addSequential(new a_drive_move_dist(113+4, driveSpeed), 3.5);
    	addSequential(new a_drive_turn_angle(90, turnspeed), 2);
    	addParallel(new a_lift_move_dist(20, liftSpeed));
    	addSequential(new a_drive_turn_angle(15, turnspeed), 2);
    	addSequential(new a_drive_move_dist(41, driveSpeed), 2);
    	addParallel(new a_lift_move_dist(-15, liftSpeed));
